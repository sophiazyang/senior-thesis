...
model_summ <- summary(glmer_fit)
saveRDS(model_summ, "data/model_summ.rds")

df <- model.frame(glmer_fit)
saveRDS(df, "data/model_resids.rds")
```

```{r}
model_summ <- readRDS("data/model_summ.rds")
model_summ

# playing around...
df <- readRDS("data/model_resids.rds")
