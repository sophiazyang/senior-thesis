...
new_vars_df <- clean_term_df |>
  ...
  group_by(term_enrolled, class_nbr_rev) |>
...
```{r}
model <- glm(is_SU ~ term_enrolled + catalog_level + division_of_course + class_component + student_acad_prog + has_BS + timeperiod, 
