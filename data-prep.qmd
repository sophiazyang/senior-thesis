...
table(
  divisions_df$semester_num[!is.na(divisions_df$semester_num)],
  divisions_df$academic_level_bot[!is.na(divisions_df$academic_level_bot)]
)
```
