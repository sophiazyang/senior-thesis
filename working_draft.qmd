...
To evaluate model fit I use a variety of metrics including:

-   Akaike Information Criterion: $AIC = 2k - 2 \ln(L)$, where $k$ is the number of estimated parameters and $L$ is the maximum value of the likelihood function
