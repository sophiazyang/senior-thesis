...
all_metrics |>
  ...
  kable(
    digits = 3,
    caption = "Model diagnostic values from model with random effect (no SMOTENC)"
  ) |> 
  kable_paper("striped", full_width = F) |>
  pack_rows("Model Fit", 1, 3) |>
  pack_rows("Predictive Metrics", 4, 7) |>
  kable_styling(latex_options = "HOLD_position")
```
